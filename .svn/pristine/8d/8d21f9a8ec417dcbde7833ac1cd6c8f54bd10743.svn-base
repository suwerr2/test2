...
<div class="contents">
	...
	<div class="arrRegList">
		...
		<table class="tblType01 mt20">
			...
			<tr>
				<th>파일</th>
				<td>
					<%-- <a href="javascript:layer_open_common('sheetMusic')" data-score-url = "${command.compositionCommand.composeScoreWeb}" class="showScore" data-score-url="">  --%>
	...
	<div class="arrInfoWrap">
		...
		<img id = "arrange-frequency-holder" height = "70px" src="${command.arrangeCommand.arrangeSoundPng}" alt="" style="width: 95%;">
		...
		<div> 
			...
			<p class="ml130">* Midi 파일등의 연주에 도움이 될 수 있는 파일을 올릴 수 있습니다. zip (압축)파일이어야 합니다.</p>
		</div>
		<h4>편곡자 메모</h4>
	...
	<div class="arrInfoWrap">
		...
		<div class="contBox01">
			<ul>
				<li>해당 편곡이 판매 되었을 때 받으실 배분율을 선택해주세요.</li>
				<li>배분율에 대해서 알고 싶으시면 <a class="linkArea" href="#none">여기</a>를 클릭하세요.</li>
				<li>무료로 배포하시더라도 차후 2차 수익이 발생했을 때를 위해서 기입해 주세요. 
                    <input type="text" id="arrangeRate" class="abandonmentPoint" name="arrangeCommand.arrangeRate" value="${command.arrangeCommand.arrangeRate}" style="width: 100px; text-align: right;"> &nbsp;%
				</li>
			</ul>
		</div>
	</div>
	...
	<div class="tabWrapType1">
		...
		<div class="tabCont">
			...
			<div class="arrInfoWrap">
				...
				<table class="tblType02 addTrType2">
					<colgroup>
						<col style="width: 10%">
						<col style="width: 8%">
						<col style="width: auto">
					...
					<tr>
						...
						<td>
							...
							<input type = "text" 	name = "performanceCommands[${status.index}].performMemberName" value = "${performanceCommand.performMemberNickName}" class = "selectedMemberBox" readonly  placeholder="선택한 연주자 이름" style="width: 200px;">
						</td>
						<td>
						    
				            <fmt:parseNumber  var = "performRate" value = "${performanceCommand.performRate}" pattern="0" />
							<input type="text" name = "performanceCommands[${status.index}].performRate" value = "${performRate}" style="width: 50px; text-align: right;" 
						...
						<c:choose>
							<c:when test ="${performanceCommand.performStatus == '03' or performanceCommand.performStatus == '04'}">
								<td>
				...
				<input type="text" name = "arrangeCommand.lyricsRate" id ="lyricsRate" value ="${command.arrangeCommand.lyricsRate}" 
					style = "width: 96px; text-align: right;" class ="compseRate abandonmentPoint" >&nbsp;%&nbsp; 배분
			</div>
		</div>
		<!-- //tabBox1 -->
		<!-- tabBox2 -->
			...
			<ul class="soundSource arrList2">
				<li>
					<div class="soundSource">
						<p class="musician">Keyboards</p>
						<div class="soundArea">
							<div class="soundHeader">
								<a href="#none" class="bulPlay" data-sound-url=""><i
									class="fa fa-play-circle fa-2x"></i></a> <span class="songTitle"><input
									type="text" placeholder="김지민"></span>
							</div>
							<!-- 개발에서 확인요망 -->
							<div class="soundBody">
								<div class="pajaImg">
									<img src="../resources/images/holderType2.gif" alt=""
										style="width: 100%;">
								</div>
								<div class="soundBar"></div>
							</div>
				...
				<li>
					<div class="soundSource">
						<p class="musician">Guitar<p>
						<div class="soundArea">
							<div class="soundHeader">
								<a href="#none" class="bulPlay" data-sound-url=""><i
									class="fa fa-play-circle fa-2x"></i></a> <span class="songTitle"><input
									type="text" placeholder="안영철"></span>
							</div>
							<!-- 개발에서 확인요망 -->
							<div class="soundBody">
								<div class="pajaImg">
    ...
    <div class="arrInfoWrap oh">
        <div class="ml30 mb10">
            <div class="floatL">
                <a class="uploadBtn" href="#none" data-upload-type = "5" ><span>최종 편곡 파일</span></a>
            </div>
            <p class="uploadPut">
            	<img id ='arrange-sound-progress-img' src = ''>
				<span style ="padding-left: 10px" id ='arrange-sound-progress-string'></span>
        ...
        <div class="soundBody floatL ml10" style="width: 96%;">
            <div class="pajaImg">
                <img src="../resources/images/holderType2.gif" alt="" style="width: 100%;">
            </div>
            <div class="soundBar mg0"></div>
        </div>
    </div>
    <div class="arrInfoWrap oh mb30">
        <div class="ml30 mb10">
            <div class="floatL">
                <a class="uploadBtn" href="#none" data-upload-type = "6"><span>보컬 가이드 편곡</span></a>
            </div>
                <p class="uploadPut">
            		<img id ='arrange-sound-progress-img' src = ''>
					<span style ="padding-left: 10px" id ='arrange-sound-progress-string'></span>
	...
	<div class="btnAreaType01">
		<div class="textR">
			<a class="btn large btnPoint" href="#none" id ="arrange-update-submit2"><span>판매개시</span></a>
			<a class="btn large" href="/music/workspace/workspaceList?listType=1"><span>취소</span></a> 
			<a class="btn large btnPoint" href="#none" id ="arrange-update-submit"><span>임시저장</span></a>
		</div>
	</div>
			...
			<div class="layerPopupWrap">
				...
				<div class="popCont">
					<div class="tabWrapType1">
						...
						<div class="tabCont">
							<div class="floatL mb10">
								<select id="selectOpt" class="dropdown" name="">
								    <option value="01">ID</option>
								    <option value="02">NICK</option>
								</select>
							</div>
							<div class="floatR mb10">
								<input id="searchArranger" type="text"><a id="getSelectArranger" class="btn small btnPoint ctgView" href="#none"><span>검색</span></a>
							</div>
	...
	<div class="layer">
		...
		<div id="vocalSearch" class="pop-layer">
			<div class="layerPopupWrap">
				...
				<div class="popCont">
					<div class="floatL mb10">
						<select id="selectOptVocal" class="dropdown" name="">
                            <option value="01">ID</option>
							<option value="02">NICK</option>
						</select>
					</div>
					<div class="floatR mb10">
						<input id="searchVocal" type="text"><a id="getSelectVocal" class="btn small btnPoint ctgView" href="#none"><span>검색</span></a>
					</div>
					<table id="desk_vocal_item_emp" class="tblType03 addTrType2">
						<colgroup>
							<col style="width: 8%">
							<col style="width: 25%">
							<col style="width: 20%">
...
<script type = "text/javascript">
	...
	$(document).ready(function() {
		...
		$('#arrangeRate').val(Math.floor($('#arrangeRate').val()));
		$('#lyricsRate').val(Math.floor($('#lyricsRate').val()));
        ...
        getMultiEmpInfoDeskPopListAjax(false);
		getMultiEmpInfoDeskPopAjax(false);
        getMultiEmpInfoDeskPopVocalListAjax(false);
	    ...
	    $('#arrange-update-submit').click(function(event){
	    	...
	    	//기타 입력갑 검증
	    	//검증이 통과할 경우 폼 제출
	    	$('#arrange-update-form').attr('action','/music/arrange/update?codeStatus=1').submit();
	    });
	    //폼 등록 버튼 클릭시 호출
	    $('#arrange-update-submit2').click(function(event){
	    	event.preventDefault();
	    	if (!checkRate()){
	    		alert("수익 배분은 작곡자, 편곡자 , 작사가 배분율을 더해서 \n총 100 % 가되어야 합니다");
	    		return;
	    	...
	    	//기타 입력갑 검증
	    	//검증이 통과할 경우 폼 제출
	    	$('#arrange-update-form').attr('action','/music/arrange/update?codeStatus=2').submit();
	    });
	    //폼 등록 버튼 클릭시 호출
	    $('#arrange-update-submit3').click(function(event){
	    	event.preventDefault();
	    	if (!checkRate()){
	    		alert("수익 배분은 작곡자, 편곡자 , 작사가 배분율을 더해서 \n총 100 % 가되어야 합니다");
	    		return;
	    	...
	    	//기타 입력갑 검증
	    	//검증이 통과할 경우 폼 제출
	    	$('#arrange-update-form').attr('action','/music/arrange/update?codeStatus=3').submit();
	    });
	    ...
	    $(document).on('change', '#arrangeRate, #lyricsRate', function(){
 	    ...
 	    $("#getSelectArranger").on("click", function () {
 	    	getMultiEmpInfoDeskPopAjax(false);
 	    });
 	    
 	    $("#getSelectVocal").on("click", function () {
 	    	getMultiEmpInfoDeskPopVocalListAjax(false);
 	    });
	});
	
	// 참여 연주자 리스트 조회
	function getMultiEmpInfoDeskPopListAjax(init){

		var arrangeNo = "${command.arrangement.arrangeNo}";
		
		 url = "/music/common/musicianArrangementParticipationSelectList?arrangeNo="+ arrangeNo;
          			...
          			total_cnt = Object.keys(state).length;
						...
						var j = i + 1;
			             ...
			             $("#desk_list_item_emp").append(
			 					"<tr>" +
			 					"<td>" + j + "</td>" +
			 					"<td>" + data['memberUserId'] + "</td>" +
			 					"<td>" + data['memberNickName'] + "</td>" +
			 					"<td>" + data['musicField'] + "</td>" +
			 					"<td>" +
			 					"<a class='btn small btnPoint ctgView' href='#none'>" +
			 					"<span data-member-no = '" + data['memberNo'] + "' data-member-name = '" + data['memberNickName'] + "' class = 'select-member'>select</span>" +
			 					"</a>" +
			 					"</td>" +
			 					"</tr>"
			              ); 
	...
	// 연주자 리스트 조회
	function getMultiEmpInfoDeskPopAjax(init){
		
		 url = "/music/common/musicianArrangementSelectList?memberUserId="+$("#searchArranger").val()+"&selectOpt="+$("#selectOpt").val();
		 ...
		 $("#desk_item_emp tr:not(:first)").remove();
          	  ...
          	  if(key=='objects'){  //objects만 추출
          			...
          			total_cnt = Object.keys(state).length;
						...
						var j = i + 1;
						 ...
						 if (data['performPlayerStatus'] == '01') {
			             	$("#desk_item_emp").append(
			 						"<tr>" +
			 						"<td><font color='blue'>" + j + "</font></td>" +
			 						"<td><font color='blue'>" + data['memberUserId'] + "</font></td>" +
			 						"<td><font color='blue'>" + data['memberNickName'] + "</font></td>" +
			 						"<td><font color='blue'>" + data['musicField'] + "</font></td>" +
			 						"<td><font color='blue'>" +
			 						"<a class='btn small btnPoint ctgView' href='#none'>" +
			 						"<span data-member-no = '" + data['memberNo'] + "' data-member-name = '" + data['memberNickName'] + "' class = 'select-member'>select</span>" +
			 						"</a>" +
	...
	// 보컬 리스트 조회
	function getMultiEmpInfoDeskPopVocalListAjax(init){
		
		 url = "/music/common/musicianArrangementVocalSelectList?memberUserId="+$("#searchVocal").val()+"&selectOpt="+$("#selectOptVocal").val();
		 ...
		 $("#desk_vocal_item_emp tr:not(:first)").remove();
