...
public class CompositionController extends ApplicationController{
	...
	public String composeDetail(
		...
		model.addAttribute("CompositionCommand", compositionService.getCompositionCommandByComposeNo(composeNo, loginMemberNo));
	...
	public String showRegisterForm(
		...
		CompositionCommand compositionCommand = compositionService.getCompositionCommandByComposeNo(composeNo, loginMemberNo);
		...
		composeUpdateCommand.setRedirectUrl(redirectUrl);
	...
	public String register(
		...
		return "redirect:"+composeUpdateCommand.getRedirectUrl();
	}
	...
	public String composeList(	
		...
		String returnUrl = ArrangeForward.COMPOSE_LIST;
		return returnUrl;
	...
	{	
		...
		int composeTotalRow = compositionService.getCompositionCount(isSearch, searchWord);		
