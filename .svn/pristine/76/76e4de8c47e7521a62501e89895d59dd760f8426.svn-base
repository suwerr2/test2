...
public class CommentDaoImpl implements CommentDao {
	...
	@Override
	public ArrayList<CommentCommand> getAllComments2(String musicClassNo, int arrangeNo) {
		return commentMapper.getAllComments2(musicClassNo, arrangeNo);
	}

	@Override
	public ArrayList<CommentCommand> getCommentsByMusicClassNoAndMusicNo(
			String musicClassNo, int musicNo) {
