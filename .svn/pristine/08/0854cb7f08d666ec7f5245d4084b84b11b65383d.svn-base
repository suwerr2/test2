    ...
    pageEncoding="UTF-8"%>
		...
		<div class="b_inline">
			<form method="get" name="find_id" id="find_id" action="searchPage">
				...
				<span class="ml_5"> <spring:message code ="msg.alert.forgotId"/> </span> -->
				<input type="hidden" name ="type" value="1">  
				<input type="submit" class="btn-ms2"  value="<spring:message code ="title.findId"/>">  
		    </form>
		</div>
		<div class="b_inline">
			<form method="get" name="find_pass" id="find_pass" action="searchPage">
				...
				<input type="submit" class="btn-ms2"  value="<spring:message code ="title.findPassword"/>">  
			</form>
		</div>
		<div class="b_inline">
			<form method="get" name="GotoJoin" id="GotoJoin" action="join_step1">
				...
				<input type="submit" class="btn-ms2"  value="<spring:message code ="title.memberRegistration"/>">  
			</form>
		</div>	
	</div>