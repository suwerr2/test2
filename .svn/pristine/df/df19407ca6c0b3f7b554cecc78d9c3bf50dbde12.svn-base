...
function addRowType1() {
    ...
    if (buttonSetType === "01") {
        ...
        $(".arrList li:last-child .btnType3, .arrList li:last-child .btnType4, .arrList li:last-child .btnType7, .arrList li:last-child .btnType8, .arrList li:last-child .btnType12").remove();
...
//20141018 업로드 다운로드 버튼추가 수정
    function addRowType2() {
        $(".arrList2").append(
            ...
            "           </div> " +
            "       </div> " +
            "       <div class='btnRigArea'> " +
            "           <a href='#none' class='btn large'><span>업로드</span></a> " +
            "           <a href='#none' class='btn large btnPoint'><span>다운로드</span></a> " +
            "       </div> " +
            "   </div> " +
            "</li>"
        );
    ...
    $(".addLineType2").on("click", function () {
        if ($(this).parents(".arrInfoWrap").find("tr").length < 8) {
            ...
            $(this).parents(".tabCont").find(".addTrType2").append(
                ...
                "   <td><input type='text' placeholder='선택한 연주자 이름' value=''></td>" +
                "   <td class='textR'><input type='text' style='text-align: right;'> % 배분</td>" +
