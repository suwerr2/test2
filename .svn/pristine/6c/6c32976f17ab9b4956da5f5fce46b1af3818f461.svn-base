...
public enum ForwardingMessageType {
	...
	LOGIN_FAIL						(1,	 "로그인 실패",					"이이디와 비밀번호를 확인해 주세요. </br>ma2rix에 등록되지 않은 아이디 또는 비밀번호를 입력하셨습니다." ),
	...
	private ForwardingMessageType(int messageType, String mainMessage,
			String subMessage) {
	...
	public String mainMessage(){return this.mainMessage;}
	public String subMessage(){return this.subMessage;}
