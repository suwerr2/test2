...
/**
 * 순위 리스트에 사용되는 Command
 */
public class RankCommand implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private DateTime regDatetime;						/* 기준날짜 */
	private String rankName;							/* 메뉴명 */
	private String rType;								/* 구분(주별,달별) */
	private int rankDetailNo;							/* 순위상세일련번호 */
	private int rankSort;								/* 순위정렬번호 */
	...
	private int rankNo;									/* 순위일련번호 */
	private int limitNum;								/* 가져올 갯수 */	
	private int isRecom;								/* 추천 싱글여부 */
	private int isRecent;								/* 최신 싱글여부 */
	private int isSelected;								/* 현재 보여줄 달,주 리스트 선택 */
	...
	public RankCommand(DateTime regDatetime, String rankName, String rType,
			int rankDetailNo, int rankSort, int arrangeNo, int composeNo,
			...
			String saleStatus, int rankNo, int limitNum, int isRecom,
			int isRecent, int isSelected) {
		super();
		this.regDatetime = regDatetime;
		this.rankName = rankName;
		this.rType = rType;
		this.rankDetailNo = rankDetailNo;
	...
	public int getRankDetailNo() {
		return rankDetailNo;
	}
	public void setRankDetailNo(int rankDetailNo) {
		this.rankDetailNo = rankDetailNo;
	}
