...
public class Performance {
	...
	public void initPerformance(Performance performance){
		this.choiceStatus = AppConstants.SelectStatus.NOT_SELECT;
		this.confirmStatus = AppConstants.ConfirmStatus.NOT_CONFIRM;
		if (this.getPerformMemberNo() == 0) {
			this.performStatus = AppConstants.PerformStatus.PERFORM_UNSPECIFIED;
		} else {
			this.performStatus = AppConstants.PerformStatus.PERFORM_WAITING;
		}
	}
