...
<head>
	...
	<link href="../resources/common/css/jquery-ui.css" rel="stylesheet" type="text/css" />
...
/*  			var result = winLoc.indexOf("=");
		...
		if ( getCookie( "oneNotice" ) !="done" && '${accPop}'== "Y") {
				noticeWindow  =  window.open('/music/user/regAccPop','notice','directories=0,titlebar=0,toolbar=0,location=0,status=0,menubar=0,scrollbars=0,resizable=0,left=0, top=0, width=500,height=200');
...
<!-- 	                <span class="mChart"><a class="btn ylw" href="#none"><span>Ma2rix Chart</span></a></span> -->
					...
					<ul class="dropType1 dropStyle3">
               		...
               		<ul class="dropType1 dropStyle1">
	                    <li>
	                        <a class="btn gnbTopayc" href="#none"><span>${userName}</span>
	                        <img src="../resources/images/arrage/arrow01.png" alt=""></a>
	                        <ul>
	                            <li><a href="/music/user/myProfile?memberNo=${memberNo}">My Profile</a></li>
	                            <li><a href="/music/user/myFan?tabActiveNum=1&memberNo=${memberNo}">My Playlist</a></li>
	                            <li class="div"><a href="/music/user/myFan?tabActiveNum=0&memberNo=${memberNo}">My Fans</a></li>
	                            <li class="mt8"><a href="/music/workspace/workspaceList?listType=1&memberNo=${memberNo}">Workspace</a></li>
	                            <li><a href="#none">My Message</a></li>
	                            <li class="div"><a href="/music/settle/myIncome">My Income</a></li>
