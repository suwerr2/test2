	...
	<div class="mrWrap">
		...
		<div class="mrHeader">
			<div class="headerArea">
	            ...
	            <div class="gnbWrap">
		            <ul>
		            	<li><a href="/music/log/logList">로그인 이력조회</a></li>
		                <li><a href="/music/settle/settlementList">정산조회(관리자)</a></li>
		                <li><a href="/music/compose/composeList">정산조회(개인)</a></li>
		                <li><a class="on" href="/music/event/eventList">무료구매관리(이벤트기간, 횟수지정)</a></li>
		                <li><a href="/music/log/viewManage">관리자 곡선택 노출관리</a></li>
		            </ul>
		        </div>
	    	</div>
		</div>
