                ...
                <div class="detailTop">
                	...
                	<div class="soundArea">
                		<div class="soundHeader">
							...
							<span class="songSinger profilePop"><a href="javascript:getProfilePopAjax('${CompositionCommand.composeMemberNo}')">by ${CompositionCommand.composeMemberNickName}</a></span>
						</div>
