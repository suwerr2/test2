...
<div class="contents">
	<div class="m_com">
		<h2 class="tit wrap"><spring:message code ="title.login"/></h2>
		<div class="login">
			<strong> Enjoy your ma2rix </strong>
			<p class="mt_20 textC"><spring:message code ="title.login"/></p>
				...
				<div class="otherLogin">
				 ...
				 <div class="loginArea">
					<form id="login" name="login" method="post">
						<div class="email">
							<input type="text" name="email" id="email" value="${loginCommand.email}" class="selectInput" style="width: 390px;" placeholder="<spring:message code ="msg.inut.email"/>">
							<p id="alert1" class="vb_hid fc_red"><spring:message code ="msg.input.correctEmail"/></p>
						</div>
						<div class="pw">
							<input type="password" name="password" id="password" class="selectInput" style="width: 390px;" placeholder="<spring:message code ="title.password"/>">
							<p id="alert2" class="vb_hid fc_red"><spring:message code ="msg.input.password"/></p>
						</div>
						<div class="loginKeep">
							<input type="button" class="btnLogin" name="login_box" id="login_box" value="<spring:message code ="title.login"/>">
							<input type="checkbox" value="keep_login" name="emailcookie" id="emailcookie"><label for="emailcookie"><spring:message code ="title.stayLogin"/></label>
						</div>
