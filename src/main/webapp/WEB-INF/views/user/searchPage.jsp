			...
			<div class="searchId">
				<!-- <p class="mt30 mb10">* ${message.subMessage} *</p> -->
			 	<form id="id_sh" name="searchPage"  method="post">
					...
					<input type="text" name="email" id="email" class="w_300 plr_10" value="${mailSendRequest.email}" placeholder="<spring:message code ="msg.inut.email"/>">
					<p id="alert1" class="vb_hid ml_30 fc_red"><spring:message code ="msg.inut.email"/></p>
					<input type="text" class="dp_none"/>
					<input type="button" id="id_sh_box" value="<spring:message code ="title.confirm"/>">
				</form> 
			</div>
		</div>
