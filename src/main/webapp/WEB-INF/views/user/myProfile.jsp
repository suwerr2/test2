            ...
            <div class="contents">
                ...
                <div class="profileLeft">	
                	...
                	<div class="mySponsor">
                		<div class="header">
	                		<h3>Sponsor</h3>
	               			<a class="floatR" href="/music/user/myFan?tabActiveNum=3&memberNo=${profileCommand.user.memberNo}">view more</a>
	               		</div>
               			<div class="nowMoney">
...
<!--                				<p>목표금액 <strong> 1000 $</strong></p>   -->
                ...
                <div class="profileRight">
	                ...
	                <div class="header">
	                	...
	                	<a class="floatR" href="/music/user/myFan?tabActiveNum=1&memberNo=${profileCommand.user.memberNo}">view more</a>
	                </div>
	                <div class="conList">
	                	<ul>
	                	<c:forEach items="${playList}" var="playList">	                	
	                		<li>
	                			<div class="visual"><img src="/music/resources/images/holderType3.gif" alt="" style="width: 50px; height: 50px;"></div>
	                			<p class="detail">
	                				${playList.arrangeTitle}<br>
	                				${playList.memberName}
	                			</p>
	                		</li>
	                		</c:forEach>
	                ...
	                <div class="header">
	                	<h3>${starCnt} Stars</h3>
	                	<a class="floatR" href="/music/user/myFan?tabActiveNum=2&memberNo=${profileCommand.user.memberNo}">view more</a>
	                </div>
	                <div class="conList">
	                	<ul>
