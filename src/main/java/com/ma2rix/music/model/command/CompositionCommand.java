...
public class CompositionCommand implements Serializable {
	...
	public CompositionCommand(int composeNo, int musicNo, int composeMemberNo,
			String composeMemberName, String composeMemberNickName,
			String composeTitle, String openStatus, int composeRate,
			String composeMemo, int vocalCount, int arrangeCount, int fanCount,
			int composeHits, int composeImage, String composeImageWeb,
			String composeImageFile, int composeScore, String composeScoreWeb,
			String composeScoreFile, int composeSound, String composeSoundWeb,
			String composeSoundFile, String composeSoundMp3,
			String composeSoundOgg, String composeSoundPng, float salePrice,
			String chargeStatus, String composeStatus, String saleStatus,
			DateTime regDateTime, int modAdminNo, int downloadCount,
			int arrangeMemberNo, int fanHeartCount, int loginMemberNo) {
		super();
	...
	public int getComposeRate() {
		return composeRate;
	}


	public void setComposeRate(int composeRate) {
		this.composeRate = composeRate;
	}
	...
	public void setFaHeart(int fanHeartCount) {
		this.fanHeartCount = fanHeartCount;
	}
