...
public class PerformanceCommand implements Serializable {
	...
	public PerformanceCommand(int performNo, int arrangeNo, int playFieldNo,
			...
			String performSoundOgg, String performSoundPng, String arrangeMemo,String performMemo,
			String performStatus,String performStatusName,
		...
		this.performStatusName = performStatusName;
	...
	public String getPerformStatusName() {
		return performStatusName;
	}

	public void setPerformStatusName(String performStatusName) {
		this.performStatusName = performStatusName;
	}
