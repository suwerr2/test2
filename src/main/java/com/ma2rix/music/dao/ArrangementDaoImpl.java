...
public class ArrangementDaoImpl implements ArrangementDao {
	...
	public int getArrangementCount(int genreNo, int listType) {
		return arrangementMapper.getArrangementCount(genreNo, listType);
	}
	
	@Override
	public int getArrangementCountByComposeMemberNo(int arrangeMemberNo) {
		return arrangementMapper.getArrangementCountByComposeMemberNo(arrangeMemberNo);
	}	
	...
	public ArrayList<ArrangementCommand> getArrangementCommandList(int genreNo,
		...
		return arrangementMapper.getArrangementCommandList(genreNo, pageCount, pageOffset, orderBy, listType);
	}
	...
	public Performance getPerformancesByPerformNo(int performNo) {
		return arrangementMapper.getPerformancesByPerformNo(performNo);
	}
	...
	public int getArrangementCountByArrangeNo(){
		return arrangementMapper.getArrangementCountByArrangeNo();
	}
