...
public final  class AppConstants {
	...
	public static final class ComposeStatus{
		...
		public static final String COMPOSER_ROOM_PURCHASE      = "01";
		public static final String COMPOSING						= "02";
		public static final String COMPOSE_COMPLETED			= "03";
	}
	
	/* 판매 상태*/  
	public static final class SalesStatus {
		public static final String CLASS_CODE 					= "MA011"; 
		public static final String STOP_SALE					    = "01";
		public static final String ING_SALE						= "02";
	...
	public static final class ArrangeStatus {
		...
		public static final String ARRANGING_ROOM_PURCHASE     = "01";
	...
	public static final class PerformStatus {
		...
		public static final String PERFORM_UNSPECIFIED          = "01";
		public static final String PERFORM_WAITING              = "02";
		public static final String PERFORM_COMPLETED			= "03";
		public static final String ARRANGE_COMPLETED			= "04";
	}
	...
	public static final class VocalStatusEx {
		...
		public static final String VOCAL_PURCHASE_REQUEST     = "01";
		public static final String VOCAL_ROOM_PURCHASE        = "02";
		public static final String ING_VOCAL					   = "03";
		public static final String VOCAL_COMPLETED			   = "04";
	}
	...
	/* 연주 참여 상태*/  
	public static final class PerformParticipationStatus {
		public static final String CLASS_CODE 					= "MA035"; 
		public static final String REQUEST_PERFORMER			= "01";
		public static final String ING_PERFORM			        = "02";
		public static final String PERFORM_COMPLETED			= "03";
		public static final String ELIMINATION                  = "04";
		public static final String WITHDRAW                      = "05";
		public static final String FORCE_WITHDRAW               = "06";
	}
