...
public class UploadServiceImpl implements UploadService {
	...
	public void uploadCompose(int musicNo, 
		...
		System.out.println(">>uploadCompose.start");
		...
		try {
			...
			case COMPOSE_IMAGE:
				...
				System.out.println(">>uploadCompose.attachNo::"+attachNo);
				if (attachNo == 0){
					attachMusic = new AttachMusic();
			...
			case COMPOSE_SCORE:
				attachNo = composition.getComposeScore();
				System.out.println(">>uploadCompose.attachNo::"+attachNo);
				if (attachNo == 0){
					attachMusic = new AttachMusic();
					attachMusic.setMusicClass(AppConstants.MusicClass.COMPOSE);
					...
					attachMusic.setFileName2(newFileName);
					attachMusicService.insertAttachMusic(attachMusic);
					composition.setComposeScore(attachMusic.getAttachNo());
					compositionService.updateComposition(composition);
			...
			case COMPOSE_SOUND:
				attachNo = composition.getComposeSound();
				System.out.println(">>uploadCompose.attachNo::"+attachNo);
				if (attachNo == 0){
					attachMusic = new AttachMusic();
					attachMusic.setMusicClass(AppConstants.MusicClass.COMPOSE);
					...
					attachMusic.setFileName2(newFileName);
					attachMusicService.insertAttachMusic(attachMusic);
					composition.setComposeSound(attachMusic.getAttachNo());
					compositionService.updateComposition(composition);
